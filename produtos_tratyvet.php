...
<li><a class="active" href="produtos_tratyvet.php"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="23" fill="currentColor" class="bi bi-bag" viewBox="0 0 17 19">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <?php //Inicia PHP
                                            ...
                                            $sql = "SELECT * FROM estoque_tratyvet";
