...
<li><a class="active" href="produtos_tesouras.php"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="23" fill="currentColor" class="bi bi-bag" viewBox="0 0 17 19">
  <path d="M8 1a2.5 2.5 0 0 1 2.5 2.5V4h-5v-.5A2.5 2.5 0 0 1 8 1zm3.5 3v-.5a3.5 3.5 0 1 0-7 0V4H1v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4h-3.5zM2 5h12v9a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V5z"/>
...
<div style="left: 5%;position: relative" class="container p-5 my-5 border">
  <h1>Tabela de Produtos <img src="imagens/logo.png" style="height: 30%; width: 30%; left: -10px; position: relative"></h1>
  <h5>Sistema de controle de produtos.</h5>
  <br>
  <br>
    <main>
                       <div class="card mb-4">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <?php //Inicia PHP
                                            ...
                                            $sql = "SELECT * FROM estoque_tesouras";
                                            $result = mysqli_query($con,$sql) or die("Erro ao retornar dados");
                                            while($res = mysqli_fetch_array($result))
                                            {
                                                echo" <td>".$cod_produto = $res['cod_produto']."</td>";
                                                echo"  <td>".$res['nome_produto']."</td>";
                                                echo"  <td>".$res['preco_produto']."</td>";
                                                echo"  <td>".$res['categoria_produto']."</td>";
                                                echo"  <td>".$res['marca_produto']."</td>";
                                                echo"  <td>".$res['quantidade_estoque']."</td>";
                                                echo "   </tr>";
                                            }
                                        echo'  </tbody>';
                                        mysqli_close($con);
                    ...
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; WLG Distribuidora 2023</div>
                            <div>
