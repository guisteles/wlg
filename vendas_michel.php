...
<li><a href="produtos_tesouras.php"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="23" fill="currentColor" class="bi bi-bag" viewBox="0 0 17 19">
 ...
 <li><a class="active" href="vendas_michel.php"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-cart-check-fill" viewBox="0 0 17 19">
  <path d="M.5 1a.5.5 0 0 0 0 1h1.11l.401 1.607 1.498 7.985A.5.5 0 0 0 4 12h1a2 2 0 1 0 0 4 2 2 0 0 0 0-4h7a2 2 0 1 0 0 4 2 2 0 0 0 0-4h1a.5.5 0 0 0 .491-.408l1.5-8A.5.5 0 0 0 14.5 3H2.89l-.405-1.621A.5.5 0 0 0 2 1H.5zM6 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm7 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm-1.646-7.646-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L8 8.293l2.646-2.647a.5.5 0 0 1 .708.708z"/>
                       ...
                       <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    <thead>
                                        <tr>
                                            <th>Código do Produto Michel</th>
                                            <th>Código do Produto Traty Vet</th>
                                            <th>Código do Produto Propetz</th>
                                            <th>Código do Produto Tesouras</th>
                                    ...
                                    <tbody>
                                        ...
                                        <?php //Inicia PHP
                                            ...
                                            $sql = "SELECT * FROM produtos_michel";
                                            $result = mysqli_query($con,$sql) or die("Erro ao retornar dados");
                                            while($res = mysqli_fetch_array($result))
                                            {
                                                echo" <td>".$cod_produto_michel = $res['cod_produto_michel']."</td>";
                                                echo" <td>".$cod_produto_tv = $res['cod_produto_tv']."</td>";
                                                echo" <td>".$cod_produto_pr = $res['cod_produto_pr']."</td>";
                                                echo" <td>".$cod_produto_te = $res['cod_produto_te']."</td>";
                                                echo"  <td>".$res['data_michel']."</td>";
                                                echo "   </tr>";
                                            }
                                        echo'  </tbody>';
                                        mysqli_close($con); 
