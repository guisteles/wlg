...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="container-login">
            ...
            <form action="valida_valida_atualizar_produto_propetz.php" method="POST">
        ...
        <div class="row mb-2">
            ...
            <div class="form-outline">
                <input type="text"  class="form-control" name="nome_produto" value="<?php echo $nome_produto_pr;?>" placeholder="Nome do Produto" required />
            </div>
            </div>
            <div class="col">
            <div class="form-outline">
                <input type="number"  class="form-control" name="preco_produto" value="<?php echo $preco_produto_pr;?>" placeholder="Preço" required />
            </div>
            </div>
        </div>
        <br>
        ...
        <div class="form-outline mb-2">
            <input type="text"  class="form-control" name="categoria_produto" value="<?php echo $categoria_produto_pr;?>" placeholder="Categoria" required />
        </div>
        <br>
         <!-- Text input -->
         <div class="form-outline mb-2">
            <input type="number" class="form-control" name="quantidade_estoque" value="<?php echo $quantidade_estoque_pr;?>" placeholder="Quantidade" required/>
        </div>
        <br>
